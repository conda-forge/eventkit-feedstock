...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/eventkit-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7202&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/eventkit-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `eventkit` can be installed with:

```
conda install eventkit
```

It is possible to list all of the versions of `eventkit` available on your platform with:
